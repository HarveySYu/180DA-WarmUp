...
while(cap.isOpened()):
    ...
    lower_blue = np.array([0,25,50])
    upper_blue = np.array([0,127,255])
    ...
    if ret==True:
        ...
        if (ver_center!=0)&(hor_center!=0):
            ...
            frame[up_edge:down_edge,left_edge]=[255,0,0]
            frame[up_edge:down_edge,right_edge]=[255,0,0]
            frame[up_edge,left_edge:right_edge]=[255,0,0]
            frame[down_edge,left_edge:right_edge]=[255,0,0]
